...
impl PlayerAbilitiesPacket {
    pub fn new(
        invulnerability: bool, flying: bool, allow_flight: bool,
        instant_break: bool, flying_speed: f32, field_of_view_modifier: f32,
    ) -> ClientboundPacket {
    ...
    pub fn deserialize(buffer: &mut Buffer) -> io::Result<ClientboundPacket> {
        ...
        Ok(ClientboundPacket::PlayerAbilities(PlayerAbilitiesPacket {
            invulnerability: (flags & 0b00000001) != 0,
            flying: (flags & 0b00000010) != 0,
            allow_flight: (flags & 0b00000100) != 0,
            instant_break: (flags & 0b00001000) != 0,
    ...
    pub fn serialize(&self, buffer: &mut Buffer) -> io::Result<()> {
        ...
        if self.invulnerability { flags |= 0b00000001; }
        if self.flying { flags |= 0b00000010; }
